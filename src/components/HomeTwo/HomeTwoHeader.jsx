                    ...
                    <div className="inner-container">
                        ...
                        <div className="top-left">
                            <ul className="list-style-one">
                                <li><i className="fa fa-clock"></i> Mon - Fri: 09.00am - 10.00 pm</li>
                ...
                <div className="header-lower">
                    <div className="main-box">
                        ...
                        <div className="btn-box">
                            <Link to="/contact" className="theme-btn btn-style-one"><span className="btn-title">Request a quote</span></Link>
                        </div>
                    </div>
                </div>
