...
import ProductDetailsImg1 from '/public/assets/images/resource/products/product-details.jpg';
import ProductDetailsImg2 from '/public/assets/images/resource/products/product-details2.jpg';
import ProductDetailsImg3 from '/public/assets/images/resource/products/product-details3.jpg';
import ThumbImg1 from '/public/assets/images/resource/products/product-details.jpg';
import ThumbImg2 from '/public/assets/images/resource/products/product-details2.jpg';
import ThumbImg3 from '/public/assets/images/resource/products/product-details3.jpg';
import RelatedProduct1 from '/public/assets/images/resource/products/1.jpg';
import RelatedProduct2 from '/public/assets/images/resource/products/2.jpg';
import RelatedProduct3 from '/public/assets/images/resource/products/3.jpg';
import RelatedProduct4 from '/public/assets/images/resource/products/4.jpg';
                        ...
                        <div className="col-lg-6 col-xl-6 product-info">
                            ...
                            <div className="product-details__buttons">
                                ...
                                <div className="product-details__buttons-2">
                                    <Link to="/products-details" className="theme-btn btn-style-one"><span className="btn-title">Add to Wishlist</span></Link>
                                </div>
                            </div>
                            ...
                            <div className="tabs-content">
								...
								<div className="row clearfix">
									<div className="col-lg-6 col-md-6 col-sm-12 comment-column">
										<div className="single-comment-box">
											<div className="inner-box">
												<figure className="comment-thumb"><img src={ProductDetailsImg1} alt="Product Thumb" /></figure>
												<div className="inner">
									...
									<div className="col-lg-6 col-md-6 col-sm-12 comment-column">
										<div className="single-comment-box">
											<div className="inner-box">
												<figure className="comment-thumb"><img src={ProductDetailsImg2} alt="Product Thumb" /></figure>
												<div className="inner">
													<ul className="rating clearfix">
														<li><i className="fas fa-star"></i></li>
														<li><i className="fas fa-star"></i></li>
        ...
        <div className="product-block col-lg-3 col-md-6">
          <div className="inner-box">
            ...
            <div className="content">
              ...
              <h4><Link to="/products-details">Headphone</Link></h4>
