    ...
    return (
        <>
            ...
            <div className="items-container row" ref={isotopeContainer}>
                ...
                <div className="product-block masonry-item small-column all cat-2 product lenses mb-50 col-lg-3 col-md-6 col-sm-12">
                ...
                <div className="product-block masonry-item small-column all cat-1 cat-2 product lenses mb-50 col-lg-3 col-md-6 col-sm-12">
           		 <div className="inner-box">
					<div className="image-box">
				...
				<div className="product-block masonry-item small-column all cat-1 cat-2 cat-4 product lenses mb-50 col-lg-3 col-md-6 col-sm-12">
				<div className="inner-box">
					<div className="image-box">
			...
			<div className="product-block masonry-item small-column all cat-1 cat-3 product lenses mb-50 col-lg-3 col-md-6 col-sm-12">
				<div className="inner-box">
					<div className="image-box">
				...
				<div className="product-block masonry-item small-column all cat-1 cat-3 cat-5 product lenses mb-50 col-lg-3 col-md-6 col-sm-12">
					<div className="inner-box">
					<div className="image-box">
			...
			<div className="product-block masonry-item small-column all cat-2 cat-3 cat-4 product lenses mb-50 col-lg-3 col-md-6 col-sm-12">
				<div className="inner-box">
					<div className="image-box">
			...
			<div className="product-block masonry-item small-column all cat-1 cat-2 cat-5 product lenses mb-50 col-lg-3 col-md-6 col-sm-12">
				<div className="inner-box">
					<div className="image-box">
				...
				<div className="product-block masonry-item small-column all cat-1 cat-4 cat-5 product lenses mb-50 col-lg-3 col-md-6 col-sm-12">
					<div className="inner-box">
						<div className="image-box">
